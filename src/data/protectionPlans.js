...
/**
 * Revenue real, ANTES de IVA (el IVA es un traspaso al SAT, no ingreso de
 * MoradaUno) — un pago ÚNICO (no mensual: es % de UN mes de renta, cobrado
 * una sola vez al firmar), ya con el piso (pago mínimo) y el techo (renta
 * máxima protegida) reales de la plaza + tipo de inmueble.
 * Ej: renta $20,000, M3 Residencial → $6,000.
 *
